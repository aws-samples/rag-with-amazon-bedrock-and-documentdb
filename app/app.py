...
import chat_documentdb_and_bedrock as chat_docdb_bedrock
...
if 'llm_chain' not in st.session_state:
  st.session_state['llm_app'] = chat_docdb_bedrock
  st.session_state['llm_chain'] = chat_docdb_bedrock.build_chain()
...
def write_top_bar():
  ...
  with col2:
    ...
    header = f"An AI App powered by Amazon DocumentDB (with MongoDB Compatibility) and {provider}!"
